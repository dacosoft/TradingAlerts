...
module.exports = async function (context, req) {
    ...
    const units = (req.query.units || (req.body && req.body.units));
    ...
    if (price && units) {
        ...
        try {
            ...
            const response1 = await axios.delete('https://api.exchange.bitpanda.com/public/v1/account/orders')
            //            if (response1.status == 200) {
            const response = await axios.post('https://api.exchange.bitpanda.com/public/v1/account/orders', payload)
