...
module.exports = async function (context, req) {
    ...
    var  totalAmount = (req.query.amount || (req.body && req.body.amount));
    ...
    if (price && totalAmount) {
        ...
        try {
            ...
            context.res = {
                // status: 200, 
                body: "error:" + JSON.stringify(payload) +"!"+ e.message
            };
        }
    }
}
